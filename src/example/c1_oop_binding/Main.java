...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("""
        Перегрузка передает в метод переменную по типу ссылки переменной            - Раннее связывание
        Статические методы связываются с классом по типу ссылки переменной          - Раннее связывание
        Переопределение не статические методы связываются с классом типу реализации - Позднее связывание
        """);
