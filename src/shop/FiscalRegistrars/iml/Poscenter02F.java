...
public class Poscenter02F implements FiscalRegistrars {

    volatile static FiscalRegistrars fiscalRegistrars;

    private final String id = "Poscenter02F";
    ...
    private Poscenter02F() {
    }

    public static FiscalRegistrars getInstance() {
        if (fiscalRegistrars == null) {
            synchronized (Poscenter02F.class) {
                if (fiscalRegistrars == null) {
                    fiscalRegistrars = new Poscenter02F();
                }
            }
        }
